...
return [
    'modules' => [
        ...
        'MSP_Common' => 1,
        'MSP_DevTools' => 1,
        'MagentoTraining_BlockUpdate' => 0,
        'MagentoTraining_CusCat' => 0,
        'MagentoTraining_FeaturedCategories' => 0,
        'MagentoTraining_HelloWorld' => 0,
        'MagentoTraining_PreOrderProduct' => 1,
        'MagentoTraining_SessionalBannerImage' => 0,
        'MagentoTraining_SessionalImage' => 1,
        'MagentoTraining_StaticBlock' => 0,
        'PayPal_Braintree' => 1,
        'PayPal_BraintreeGraphQl' => 1,
        'Recodem_Shopfinder' => 1,
        'Temando_ShippingRemover' => 1,
        'Training_ChangePrice' => 1,
        'Training_CustomConfig' => 1,
        'Training_CustomerCollection' => 1,
        'Training_Example' => 0,
        'Training_Firstextension' => 1,
        'Training_FreeShippingBar' => 1,
